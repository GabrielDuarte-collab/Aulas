...
public class Controlador {
    ...
    public static void acessarConta() {
        ...
        while (tentativas < 3) {
            ...
            Telas.limparTela();
            System.out.println("Verificando credencias...");
            Cliente cliente = new Cliente();
    ...
    private static void transferir(Cliente cliente) {
        Telas.limparTela();
        String contaDestino = Telas.lerTexto("N Conta Destino: ");
        ...
        if (ok) {
            Telas.mensagem(String.format("Transferencia R$ %.2f realizada com sucesso! \nSaldo atual: R$ %.2f ",
                    valor, contaDestino, cliente.getSaldo()), false);
        } else {
